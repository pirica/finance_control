...
$totalRegistros = count($getEntryReports);
...
// Traz total de Entadas do usuário default ou com a páginação definida
...
<div class="container-fluid">
    <h1 class="text-center my-5">Relatório de Entradas <img
            src="<?= $BASE_URL ?>assets/home/dashboard-main/full-wallet.png" width="64" height="64" alt=""></h1>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="name_search" id="name_search_entry" class="form-control"
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="from_date_entry" id="from_date_entry" class="form-control placeholder"
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="to_date_entry" id="to_date_entry" class="form-control placeholder"
                            placeholder="__/__/____">
                        <div class="p-date" onclick="show_password()">
                            <i class="fa-solid fa-calendar-days"></i>
                        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($entryFinancialMovimentItem->obs != ""): ?>
                                <a href="#!" id="grupos<?= $entryFinancialMovimentItem->id ?>"
                                    onclick="openTooltip(<?= $entryFinancialMovimentItem->id ?>)"><img
                                        src="<?= $BASE_URL ?>assets/home/dashboard-main/message_alert.gif" alt="message_alert"
                                        title="ver observação" width="33" height="30"> </a>
                                <div class="tooltip_" id="tooltip_<?= $entryFinancialMovimentItem->id ?>">
                                    <div id="conteudo">
                                        <div class="bloco">
                                            <h5>Observação</h5>
                                            <a href="#!" id="close<?= $entryFinancialMovimentItem->id ?>"><i
                        ...
                        <td id="latest_moviments"><a href="#" data-toggle="modal"
                                data-target="#exampleModalCenter<?= $entryFinancialMovimentItem->id ?>" title="Editar">
                                <i class="fa-solid fa-file-pen"></i></a>
                            <a href="#!" data-toggle="modal"
                                data-target="#modal_del_finance_moviment<?= $entryFinancialMovimentItem->id ?>"
    ...
    <?php foreach ($entryFinancialMoviments as $entryFinancialMovimentItem): ?>
        <div class="modal fade" id="exampleModalCenter<?= $entryFinancialMovimentItem->id ?>" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= $BASE_URL ?>moviment_process.php?id=<?= $entryFinancialMovimentItem->id ?>"
                            method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description_edit" id="" class="form-control"
                                    ...
                                    value="<?= $entryFinancialMovimentItem->description ?>">
                            </div>
                            <div class="form-group">
                                <label for="value">Valor:</label>
                                <input type="text" name="value_edit" id="" class="form-control money"
                                    placeholder="Insira um novo valor" value="<?= $entryFinancialMovimentItem->value ?>">
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if ($entryFinancialMovimentItem->expense == "F"): ?>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="expense_type_edit" id="inlineRadio1"
                                                value="F" checked>
                                            <label class="edit_moviment_label" for="inlineRadio1">Fixa</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="expense_type_edit" id="inlineRadio2"
                                                value="V">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="obs" id="obs" rows="5"
                                    placeholder="Adicione uma observação..."><?= $entryFinancialMovimentItem->obs ?></textarea>
                            </div>
    ...
    <?php foreach ($getEntryReports as $customizeFinancialMovimentItem): ?>
        <div class="modal fade" id="customizeExpenseQuery<?= $customizeFinancialMovimentItem->id ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= $BASE_URL ?>moviment_process.php?id=<?= $customizeFinancialMovimentItem->id ?>"
                            method="post">
                            <input type="hidden" name="type" value="edit_finance_moviment">
                            <div class="form-group">
                                <label for="description">Descriçao:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="value_edit" id="" class="form-control money"
                                    ...
                                    value="<?= $customizeFinancialMovimentItem->value ?>">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="obs">Observação:</label>
                                <textarea class="form-control" name="obs" id="obs" rows="5"
                                    placeholder="Adicione uma observação..."><?= $financialMoviment->obs ?></textarea>
                            </div>
                            <input type="submit" value="Enviar" class="btn btn-lg btn-success">
                        </form>
                    </div>
